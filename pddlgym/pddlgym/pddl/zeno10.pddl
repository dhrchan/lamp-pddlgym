(define (domain zenotravel)
  ...
  (:action complete-boarding
    ...
    :effect (and (probabilistic 0.95 (and (not (boarding ?p ?a)) (in ?p ?a) (not-boarding ?p))))
  )
  ...
  (:action complete-debarking
    ...
    :effect (and (probabilistic 0.95 (and (not (debarking ?p ?a)) (at-person ?p ?c) (not-debarking ?p))))
  )
  (:action start-flying
    :parameters (?a - aircraft ?c1 - city ?c2 - city ?l1 - flevel ?l2 - flevel ?p0 - person ?p1 - person ?p2 - person ?p3 - person ?p4 - person ?p5 - person ?p6 - person ?p7 - person ?p8 - person ?p9 - person)
    :precondition (and (startflying ?a ?c2) (at-aircraft ?a ?c1) (fuel-level ?a ?l1) (next ?l2 ?l1) (not-refueling ?a)
                       (person0 ?p0) (not (boarding ?p0 ?a)) (not (debarking ?p0 ?a)) (person1 ?p1) (not (boarding ?p1 ?a)) (not (debarking ?p1 ?a)) (person2 ?p2) (not (boarding ?p2 ?a)) (not (debarking ?p2 ?a)) (person3 ?p3) (not (boarding ?p3 ?a)) (not (debarking ?p3 ?a)) (person4 ?p4) (not (boarding ?p4 ?a)) (not (debarking ?p4 ?a)) (person5 ?p5) (not (boarding ?p5 ?a)) (not (debarking ?p5 ?a)) (person6 ?p6) (not (boarding ?p6 ?a)) (not (debarking ?p6 ?a)) (person7 ?p7) (not (boarding ?p7 ?a)) (not (debarking ?p7 ?a)) (person8 ?p8) (not (boarding ?p8 ?a)) (not (debarking ?p8 ?a)) (person9 ?p9) (not (boarding ?p9 ?a)) (not (debarking ?p9 ?a)) )
  ...
  (:action complete-flying
    ...
    :effect (and (probabilistic 0.6 (and (not (flying ?a ?c2)) (at-aircraft ?a ?c2) (not (fuel-level ?a ?l1)) (fuel-level ?a ?l2))))
  )
  (:action start-zooming
    :parameters (?a - aircraft ?c1 - city ?c2 - city ?l1 - flevel ?l2 - flevel ?l3 - flevel ?p0 - person ?p1 - person ?p2 - person ?p3 - person ?p4 - person ?p5 - person ?p6 - person ?p7 - person ?p8 - person ?p9 - person)
  ...
  (:action complete-zooming
   ...
   :effect (and (probabilistic 0.8 (and (not (zooming ?a ?c2)) (at-aircraft ?a ?c2) (not (fuel-level ?a ?l1)) (fuel-level ?a ?l3))))
  )
  ...
  (:action complete-refuling
    ...
    :effect (and (probabilistic 0.95 (and (not (refueling ?a)) (not-refueling ?a) (fuel-level ?a ?l1) (not (fuel-level ?a ?l)))))
  )
)
