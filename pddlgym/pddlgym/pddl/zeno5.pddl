(define (domain zenotravel)
  ...
  (:action start-flying
    :parameters (?a - aircraft ?c1 - city ?c2 - city ?l1 - flevel ?l2 - flevel ?p0 - person ?p1 - person ?p2 - person ?p3 - person ?p4 - person)
    :precondition (and (startflying ?a ?c2) (at-aircraft ?a ?c1) (fuel-level ?a ?l1) (next ?l2 ?l1) (not-refueling ?a)
                       (person0 ?p0) (not (boarding ?p0 ?a)) (not (debarking ?p0 ?a)) (person1 ?p1) (not (boarding ?p1 ?a)) (not (debarking ?p1 ?a)) (person2 ?p2) (not (boarding ?p2 ?a)) (not (debarking ?p2 ?a)) (person3 ?p3) (not (boarding ?p3 ?a)) (not (debarking ?p3 ?a)) (person4 ?p4) (not (boarding ?p4 ?a)) (not (debarking ?p4 ?a)) )
  ...
  (:action start-zooming
    :parameters (?a - aircraft ?c1 - city ?c2 - city ?l1 - flevel ?l2 - flevel ?l3 - flevel ?p0 - person ?p1 - person ?p2 - person ?p3 - person ?p4 - person)
