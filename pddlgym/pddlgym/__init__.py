...
for env_name, kwargs in [
        ("tire_triangle", {'operators_as_actions' : False, 
                    'dynamic_action_space' : False}),
        ("tire", {'operators_as_actions' : False, 
                    'dynamic_action_space' : False}),
        ("elevators", {'operators_as_actions' : False, 
                    'dynamic_action_space' : False}),
        ("zeno2", {'operators_as_actions' : False, 
                    'dynamic_action_space' : False}),
        ("zeno5", {'operators_as_actions' : False, 
                    'dynamic_action_space' : False}),
        ("zeno10", {'operators_as_actions' : False, 
                    'dynamic_action_space' : False}),
        ("ex_blocks", {'operators_as_actions' : False, 
                    'dynamic_action_space' : False}),
        ("prob_blocks", {'operators_as_actions' : False, 
                    'dynamic_action_space' : False}),
        ("prob_blocks_ops", {'operators_as_actions' : True, 
                    'dynamic_action_space' : False}),
